    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto space-y-10">
        ...
        <div className="space-y-8 text-sm text-slate-600 leading-relaxed">
          ...
          <section className="space-y-3 p-6 rounded-2xl bg-white border border-orange-100 shadow-sm">
            <h2 className="text-lg font-bold text-slate-900">1. Introduction</h2>
            <p>
              At Dokanpat, we respect your privacy and are committed to protecting your personal data. This Privacy Policy explains how we collect, use, and safeguard your information when you use our multi-vendor SaaS platform as a seller or buyer.
            </p>
          </section>
          ...
          <section className="space-y-3 p-6 rounded-2xl bg-white border border-orange-100 shadow-sm">
            ...
            <p>
              Your information is used to operate and maintain the Dokanpat platform, process orders between buyers and independent sellers, provide customer support, and improve platform performance and security.
            </p>
          </section>
          ...
          <section className="space-y-3 p-6 rounded-2xl bg-white border border-orange-100 shadow-sm">
            ...
            <p>
              If you have any questions or concerns about this Privacy Policy or how your data is handled, please reach out to us through our <a href="/contact" className="text-orange-600 font-semibold hover:underline">Contact Page</a>.
            </p>
          </section>
