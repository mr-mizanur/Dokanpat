      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-white border border-orange-100 p-6 rounded-2xl shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl sm:text-2xl font-black tracking-tight text-slate-900">My Products</h1>
              <p className="text-xs sm:text-sm text-slate-500">Manage your inventory and store listings</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto">
            ...
            <Link href="/dashboard/seller/add-product" className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-xs font-semibold bg-gradient-to-r from-orange-600 to-amber-600 hover:from-orange-500 hover:to-amber-500 text-white shadow-md shadow-orange-500/25 transition-all">
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-20 gap-3">
            ...
            <p className="text-xs text-slate-500">Loading your products...</p>
          </div>
        ) : products.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-20 bg-white border border-orange-100 rounded-2xl text-center p-6 space-y-4 shadow-sm">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-slate-500 max-w-sm">You haven't added any products to your store yet. Get started by adding your first product.</p>
            </div>
            <Link href="/dashboard/seller/add-product" className="px-4 py-2.5 bg-gradient-to-r from-orange-600 to-amber-600 hover:from-orange-500 hover:to-amber-500 text-white text-xs font-semibold rounded-xl transition-all shadow-md shadow-orange-500/25">
              Add New Product
            </Link>
          </div>
        ) : (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {products.map((product) => (
              <div key={product._id} className="bg-white border border-orange-100 rounded-2xl overflow-hidden shadow-sm flex flex-col justify-between group hover:border-orange-200 transition-all">
                ...
                <div>
                  ...
                  <div className="relative h-48 w-full bg-slate-100 overflow-hidden">
                    ...
                    />
                    <span className="absolute top-3 right-3 px-3 py-1 bg-white/90 border border-orange-200 backdrop-blur-md rounded-full text-[10px] font-semibold text-orange-600 uppercase tracking-wider">
                      {product.category}
                    </span>
                  </div>
                  ...
                  <div className="p-5 space-y-2">
                    ...
                    <div className="flex items-center justify-between pt-2">
                      ...
                      <span className="text-xs px-2.5 py-1 bg-slate-50 border border-orange-100 rounded-lg text-slate-700">
                ...
                <div className="p-4 border-t border-orange-100 flex items-center justify-between gap-2 bg-slate-50/50">
                  <span className="text-[10px] text-slate-400 truncate max-w-[140px]">{product.sellerEmail}</span>
